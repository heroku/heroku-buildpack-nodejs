...
- Improved the error messages shown when `npm install` fails (unsupported platform, invalid package name, package not found), giving clearer, more actionable guidance.
